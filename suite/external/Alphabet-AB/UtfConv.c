...
by wiluite, Slight modifications and reduction
...
static Utf32Char* StrCpyUtf32(Utf32Char* dest, const Utf32Char* src);
static Utf32Char* StrCatUtf32(Utf32Char* dest, const Utf32Char* src);
static int StrnCmpUtf32(const Utf32Char* Utf32s1, const Utf32Char* Utf32s2, size_t ztCount);
static int StrCmpUtf32(const Utf32Char* Utf32s1, const Utf32Char* Utf32s2);
...
// Utf 16
static size_t StrLenUtf16(const Utf16Char* str);
static Utf16Char* StrCpyUtf16(Utf16Char* dest, const Utf16Char* src);
static Utf16Char* StrCatUtf16(Utf16Char* dest, const Utf16Char* src);
static int StrnCmpUtf16(const Utf16Char* Utf16s1, const Utf16Char* Utf16s2, size_t ztCount);
static int StrCmpUtf16(const Utf16Char* Utf16s1, const Utf16Char* Utf16s2);
static size_t CharLenUtf16(const Utf16Char* pUtf16);
static Utf16Char* ForwardUtf16Chars(const Utf16Char* pUtf16, size_t ztForwardUtf16Chars);
static size_t StrLenUtf32AsUtf16(const Utf32Char* pUtf32);
static Utf16Char* Utf32ToUtf16(const Utf32Char* pUtf32);
static Utf32Char* Utf16ToUtf32(const Utf16Char* pUtf16);
static Utf8Char* Utf16ToUtf8(const Utf16Char* pUtf16);
static Utf16Char* Utf16StrMakeUprUtf16Str(const Utf16Char* pUtf16);
static Utf16Char* Utf16StrMakeLwrUtf16Str(const Utf16Char* pUtf16);
static int StrnCiCmpUtf16(const Utf16Char* pUtf16s1, const Utf16Char* pUtf16s2, size_t ztCount);
static int StrCiCmpUtf16(const Utf16Char* pUtf16s1, const Utf16Char* pUtf16s2);
static Utf16Char* StrCiStrUtf16(const Utf16Char* pUtf16s1, const Utf16Char* pUtf16s2);

// Utf 8
static size_t StrLenUtf8(const Utf8Char* str);
static int StrnCmpUtf8(const Utf8Char* Utf8s1, const Utf8Char* Utf8s2, size_t ztCount);
static int StrCmpUtf8(const Utf8Char* Utf8s1, const Utf8Char* Utf8s2);
static size_t CharLenUtf8(const Utf8Char* pUtf8);
static Utf8Char* ForwardUtf8Chars(const Utf8Char* pUtf8, size_t ztForwardUtf8Chars);
...
static Utf16Char* Utf8ToUtf16(const Utf8Char* pUtf8);
