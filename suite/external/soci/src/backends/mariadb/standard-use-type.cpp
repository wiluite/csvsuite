...
void mariadb_standard_use_type_backend::bind_by_pos(
...
void mariadb_standard_use_type_backend::bind_by_name(
...
void mariadb_standard_use_type_backend::pre_use(indicator const *ind)
{
        ...
        case x_blob:
            {
                ...
                mariadb_blob_backend * bbe =
                    static_cast<mariadb_blob_backend *>(b->get_backend());
...
void mariadb_standard_use_type_backend::post_use(bool /*gotData*/, indicator* /*ind*/)
{
...
void mariadb_standard_use_type_backend::clean_up()
{
    if (buf_ != NULL)
    {
        delete [] buf_;
