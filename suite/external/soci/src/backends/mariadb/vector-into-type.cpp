...
void mariadb_vector_into_type_backend::define_by_pos(
...
void mariadb_vector_into_type_backend::pre_fetch()
{
    // nothing to do here
}
...
void mariadb_vector_into_type_backend::post_fetch(bool gotData, indicator *ind)
{
    if (gotData)
    {
...
void mariadb_vector_into_type_backend::resize(std::size_t sz)
{
    switch (type_)
    {
        // simple cases
...
std::size_t mariadb_vector_into_type_backend::size()
{
...
void mariadb_vector_into_type_backend::clean_up()
{
    // nothing to do here
}
