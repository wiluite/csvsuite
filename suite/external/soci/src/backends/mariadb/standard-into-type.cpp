...
void mariadb_standard_into_type_backend::define_by_pos(
...
void mariadb_standard_into_type_backend::pre_fetch()
{
    // nothing to do here
}

void mariadb_standard_into_type_backend::post_fetch(
        ...
        case x_blob:
            {
                ...
                mariadb_blob_backend *bbe = static_cast<mariadb_blob_backend *>(b.get_backend());
...
void mariadb_standard_into_type_backend::clean_up()
{
    // nothing to do here
}
