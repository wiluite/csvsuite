...
#ifdef SOCI_MARIADB_SOURCE
# define SOCI_MARIADB_DECL SOCI_DECL_EXPORT
#else
# define SOCI_MARIADB_DECL SOCI_DECL_IMPORT
#endif
...
class SOCI_MARIADB_DECL mariadb_soci_error : public soci_error
{
public:
    mariadb_soci_error(std::string const & msg, int errNum)
...
struct mariadb_statement_backend;
struct mariadb_standard_into_type_backend : details::standard_into_type_backend
{
    mariadb_standard_into_type_backend(mariadb_statement_backend &st)
        : statement_(st) {}
    ...
    mariadb_statement_backend &statement_;
...
struct mariadb_vector_into_type_backend : details::vector_into_type_backend
{
    mariadb_vector_into_type_backend(mariadb_statement_backend &st)
        : statement_(st) {}
...
struct mariadb_standard_use_type_backend : details::standard_use_type_backend
{
    mariadb_standard_use_type_backend(mariadb_statement_backend &st)
...
struct mariadb_vector_use_type_backend : details::vector_use_type_backend
{
    mariadb_vector_use_type_backend(mariadb_statement_backend &st)
...
struct mariadb_session_backend;
struct mariadb_statement_backend : details::statement_backend
{
    mariadb_statement_backend(mariadb_session_backend &session);
    ...
    mariadb_standard_into_type_backend * make_into_type_backend() override;
    mariadb_standard_use_type_backend * make_use_type_backend() override;
    mariadb_vector_into_type_backend * make_vector_into_type_backend() override;
    mariadb_vector_use_type_backend * make_vector_use_type_backend() override;

    mariadb_session_backend &session_;
...
struct mariadb_rowid_backend : details::rowid_backend
{
    mariadb_rowid_backend(mariadb_session_backend &session);

    ~mariadb_rowid_backend() override;
};

class mariadb_blob_backend : public details::trivial_blob_backend
{
public:
    mariadb_blob_backend(mariadb_session_backend &session);

    ~mariadb_blob_backend() override;
...
struct mariadb_session_backend : details::session_backend
{
    mariadb_session_backend(connection_parameters const & parameters);

    ~mariadb_session_backend() override;
    ...
    std::string get_backend_name() const override { return "mariadb"; }

    void clean_up();

    mariadb_statement_backend * make_statement_backend() override;
    mariadb_rowid_backend * make_rowid_backend() override;
    mariadb_blob_backend * make_blob_backend() override;
...
struct mariadb_backend_factory : backend_factory
{
    mariadb_backend_factory() {}
    mariadb_session_backend * make_session(
        connection_parameters const & parameters) const override;
};

extern SOCI_MARIADB_DECL mariadb_backend_factory const mariadb;
