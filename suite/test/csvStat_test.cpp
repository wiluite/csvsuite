///
/// \file   suite/test/csvStat_test.cpp
/// \author wiluite
...
int main() {
    ...
    struct csvStat_args : tf::single_file_arg, tf::common_args, tf::type_aware_args, tf::spread_args, csvstat_specific_args {};

    "runs"_test = [] {
        struct Args : csvStat_args {
